...
public class moosazadeh extends Activity implements B4AActivity{
	public static moosazadeh mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.doomadi.artist", "com.doomadi.artist.moosazadeh");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (moosazadeh).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.doomadi.artist", "com.doomadi.artist.moosazadeh");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.doomadi.artist.moosazadeh", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (moosazadeh) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (moosazadeh) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (moosazadeh) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._http._initialize(processBA,"http",moosazadeh.getObject());
 //BA.debugLineNum = 102;BA.debugLine="LoadDB(\"SELECT * FROM moosazadeh ORDER BY id DESC";
_loaddb("SELECT * FROM moosazadeh ORDER BY id DESC LIMIT 0,10000000000000");
...
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 612;BA.debugLine="StartActivity(hormozgan)";
...
mostCurrent._http._initialize(processBA,"job3",moosazadeh.getObject());
...
_edit._initialize(processBA,"edit",moosazadeh.getObject());
 //BA.debugLineNum = 374;BA.debugLine="edit.PostString(\"http://doholi.com/edit/edit44.ph";
_edit._poststring("http://doholi.com/edit/edit44.php","VEIW="+BA.NumberToString(_asa)+"&id="+mostCurrent._qqqq);
