...
public class alavivahid extends Activity implements B4AActivity{
	public static alavivahid mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.doomadi.artist", "com.doomadi.artist.alavivahid");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (alavivahid).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.doomadi.artist", "com.doomadi.artist.alavivahid");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.doomadi.artist.alavivahid", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (alavivahid) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (alavivahid) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (alavivahid) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 94;BA.debugLine="Activity.LoadLayout(\"layout2\")";
mostCurrent._activity.LoadLayout("layout2",mostCurrent.activityBA);
 //BA.debugLineNum = 95;BA.debugLine="File.MakeDir(File.DirRootExternal, \"doholi/music\"";
anywheresoftware.b4a.keywords.Common.File.MakeDir(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"doholi/music");
 //BA.debugLineNum = 97;BA.debugLine="ProgressDialogShow2(\"Loading...\",False)";
...
mostCurrent._http._initialize(processBA,"http",alavivahid.getObject());
 //BA.debugLineNum = 102;BA.debugLine="LoadDB(\"SELECT * FROM alavivahid ORDER BY id DESC";
_loaddb("SELECT * FROM alavivahid ORDER BY id DESC LIMIT 0,10000000000000");
...
mostCurrent._sql1.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"data.db",anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 122;BA.debugLine="tmback.Initialize(\"tmExit\",1500)";
...
String _str = "";
 //BA.debugLineNum = 529;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
 //BA.debugLineNum = 530;BA.debugLine="If KeyCode=KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 532;BA.debugLine="If Panel1.Visible=True Then";
if (mostCurrent._panel1.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 534;BA.debugLine="If isplaying=True Then";
if (_isplaying==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 536;BA.debugLine="Dim str As String";
_str = "";
 //BA.debugLineNum = 539;BA.debugLine="str=Msgbox2(\"موزیک در حال پخش قطع شود؟؟\",\"doom";
_str = BA.NumberToString(anywheresoftware.b4a.keywords.Common.Msgbox2(BA.ObjectToCharSequence("موزیک در حال پخش قطع شود؟؟"),BA.ObjectToCharSequence("doomadi music?"),"آره","نه","",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null),mostCurrent.activityBA));
 //BA.debugLineNum = 540;BA.debugLine="If str=DialogResponse.POSITIVE Then";
if ((_str).equals(BA.NumberToString(anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE))) { 
 //BA.debugLineNum = 541;BA.debugLine="music.stop";
mostCurrent._music.stop();
 //BA.debugLineNum = 542;BA.debugLine="Panel1.SetVisibleAnimated(500,False)";
mostCurrent._panel1.SetVisibleAnimated((int) (500),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 543;BA.debugLine="isplaying=False";
_isplaying = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 544;BA.debugLine="time.Text=\"ـ\"";
mostCurrent._time.setText(BA.ObjectToCharSequence("ـ"));
 //BA.debugLineNum = 545;BA.debugLine="SeekBar1.Visible=False";
mostCurrent._seekbar1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 546;BA.debugLine="timer1.Enabled=False";
mostCurrent._timer1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 547;BA.debugLine="tin.Initialize(\"tin\",1000)";
mostCurrent._tin.Initialize(processBA,"tin",(long) (1000));
 //BA.debugLineNum = 548;BA.debugLine="tin.Enabled=True";
mostCurrent._tin.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 549;BA.debugLine="ImageView6.Visible=True";
mostCurrent._imageview6.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 551;BA.debugLine="ImageView5.Visible=True";
mostCurrent._imageview5.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 553;BA.debugLine="ImageView4.Visible=True";
mostCurrent._imageview4.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 555;BA.debugLine="ImageView3.Visible=True";
mostCurrent._imageview3.setVisible(anywheresoftware.b4a.keywords.Common.True);
 }else {
 //BA.debugLineNum = 562;BA.debugLine="Return True";
if (true) return anywheresoftware.b4a.keywords.Common.True;
 };
 }else {
 //BA.debugLineNum = 566;BA.debugLine="ImageView6.Visible=True";
mostCurrent._imageview6.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 568;BA.debugLine="ImageView5.Visible=True";
mostCurrent._imageview5.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 570;BA.debugLine="ImageView4.Visible=True";
mostCurrent._imageview4.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 572;BA.debugLine="ImageView3.Visible=True";
mostCurrent._imageview3.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 578;BA.debugLine="Panel1.SetVisibleAnimated(500,False)";
mostCurrent._panel1.SetVisibleAnimated((int) (500),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 579;BA.debugLine="tin.Initialize(\"tin\",500)";
mostCurrent._tin.Initialize(processBA,"tin",(long) (500));
 //BA.debugLineNum = 580;BA.debugLine="tin.Enabled=True";
mostCurrent._tin.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 };
...
if (true) return anywheresoftware.b4a.keywords.Common.True;
 ...
 //BA.debugLineNum = 590;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 592;BA.debugLine="StartActivity(kashmar)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._kashmar.getObject()));
 //BA.debugLineNum = 593;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 595;BA.debugLine="Return True";
if (true) return anywheresoftware.b4a.keywords.Common.True;
 };
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 131;BA.debugLine="If isplaying=True Then";
if (_isplaying==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 133;BA.debugLine="timer1.Enabled=False";
mostCurrent._timer1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 };
...
anywheresoftware.b4a.objects.IntentWrapper _i2 = null;
 //BA.debugLineNum = 450;BA.debugLine="Sub Button1_Click";
 //BA.debugLineNum = 452;BA.debugLine="Try";
try { //BA.debugLineNum = 454;BA.debugLine="Dim far As Intent";
_far = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 455;BA.debugLine="Dim pm As PackageManager";
_pm = new anywheresoftware.b4a.phone.PackageManagerWrapper();
 //BA.debugLineNum = 456;BA.debugLine="far=pm.GetApplicationIntent(\"com.hanista.mobogra";
_far = _pm.GetApplicationIntent("com.hanista.mobogram");
 //BA.debugLineNum = 457;BA.debugLine="If far.IsInitialized Then";
if (_far.IsInitialized()) { 
 //BA.debugLineNum = 459;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 460;BA.debugLine="i.Initialize(i.ACTION_VIEW, \"http://telegram.me";
_i.Initialize(_i.ACTION_VIEW,"http://telegram.me/"+mostCurrent._telegram2);
 //BA.debugLineNum = 461;BA.debugLine="Dim jo As JavaObject = i";
_jo = new anywheresoftware.b4j.object.JavaObject();
_jo.setObject((java.lang.Object)(_i.getObject()));
 //BA.debugLineNum = 462;BA.debugLine="jo.RunMethod(\"setPackage\", Array As Object(\"com";
_jo.RunMethod("setPackage",new Object[]{(Object)("com.hanista.mobogram")});
 //BA.debugLineNum = 463;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(_i.getObject()));
 }else {
 //BA.debugLineNum = 466;BA.debugLine="Dim i2 As Intent";
_i2 = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 467;BA.debugLine="i2.initialize (i2.action_view,\"tg://resolve?dom";
_i2.Initialize(_i2.ACTION_VIEW,"tg://resolve?domain="+mostCurrent._telegram2);
 //BA.debugLineNum = 468;BA.debugLine="StartActivity (i2)";
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 474;BA.debugLine="Sub Button2_Click";
 //BA.debugLineNum = 475;BA.debugLine="Try";
try { //BA.debugLineNum = 476;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 477;BA.debugLine="i.Initialize(i.ACTION_VIEW,LINK2)";
_i.Initialize(_i.ACTION_VIEW,mostCurrent._link2);
 //BA.debugLineNum = 478;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(_i.getObject()));
 } 
       catch (Exception e6) {
			processBA.setLastException(e6); //BA.debugLineNum = 480;BA.debugLine="Log(LastException)";
...
public static String  _button3_click() throws Exception{
 //BA.debugLineNum = 484;BA.debugLine="Sub Button3_Click";
 //BA.debugLineNum = 486;BA.debugLine="s=Regex.Split(\"/\",linkplay)";
mostCurrent._s = anywheresoftware.b4a.keywords.Common.Regex.Split("/",mostCurrent._linkplay);
 //BA.debugLineNum = 488;BA.debugLine="ss=s(5)";
mostCurrent._ss = mostCurrent._s[(int) (5)];
 //BA.debugLineNum = 489;BA.debugLine="If File.Exists(File.DirRootExternal & \"/doholi/mu";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/doholi/music",mostCurrent._ss)==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 490;BA.debugLine="Name3= ss";
mostCurrent._name3 = mostCurrent._ss;
 //BA.debugLineNum = 491;BA.debugLine="dier=File.DirRootExternal& \"/doholi/music\"";
mostCurrent._dier = anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/doholi/music";
 //BA.debugLineNum = 492;BA.debugLine="http.Initialize(\"job3\",Me)";
mostCurrent._http._initialize(processBA,"job3",alavivahid.getObject());
 //BA.debugLineNum = 493;BA.debugLine="http.Download(linkplay)";
mostCurrent._http._download(mostCurrent._linkplay);
 //BA.debugLineNum = 494;BA.debugLine="no.Initialize";
mostCurrent._no.Initialize();
 //BA.debugLineNum = 495;BA.debugLine="no.Icon=\"icon\"";
mostCurrent._no.setIcon("icon");
 //BA.debugLineNum = 496;BA.debugLine="no.Light=False";
mostCurrent._no.setLight(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 497;BA.debugLine="no.Vibrate = False";
mostCurrent._no.setVibrate(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 498;BA.debugLine="no.sound = True";
mostCurrent._no.setSound(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 499;BA.debugLine="no.AutoCancel=True";
mostCurrent._no.setAutoCancel(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 500;BA.debugLine="no.OnGoingEvent=True";
mostCurrent._no.setOnGoingEvent(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 501;BA.debugLine="no.SetInfo(\"در حال دانلود\",Name3,Null)";
mostCurrent._no.SetInfo(processBA,"در حال دانلود",mostCurrent._name3,anywheresoftware.b4a.keywords.Common.Null);
 //BA.debugLineNum = 502;BA.debugLine="no.Notify(1)";
mostCurrent._no.Notify((int) (1));
 //BA.debugLineNum = 503;BA.debugLine="ProgressDialogShow(\"در حال دانلود فایل...صبر کنی";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,BA.ObjectToCharSequence("در حال دانلود فایل...صبر کنید"));
 //BA.debugLineNum = 504;BA.debugLine="ToastMessageShow(\"لطفا منتظر بمانید,\",  True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("لطفا منتظر بمانید,"),anywheresoftware.b4a.keywords.Common.True);
 ...
 //BA.debugLineNum = 506;BA.debugLine="ToastMessageShow(\"فایل موجود است\",  True)";
...
anywheresoftware.b4a.objects.IntentWrapper _share = null;
 //BA.debugLineNum = 510;BA.debugLine="Sub Button4_Click";
 //BA.debugLineNum = 512;BA.debugLine="Dim share As Intent";
_share = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 513;BA.debugLine="share.Initialize(share.ACTION_SEND,\"\")";
_share.Initialize(_share.ACTION_SEND,"");
 //BA.debugLineNum = 515;BA.debugLine="share.SetType(\"text/plain\")";
_share.SetType("text/plain");
 //BA.debugLineNum = 516;BA.debugLine="share.PutExtra(\"android.intent.extra.TEXT\", linkp";
_share.PutExtra("android.intent.extra.TEXT",(Object)(mostCurrent._linkplay));
 //BA.debugLineNum = 517;BA.debugLine="share.WrapAsIntentChooser(\"اشتراک گذاری آهنگ\")";
_share.WrapAsIntentChooser("اشتراک گذاری آهنگ");
 //BA.debugLineNum = 518;BA.debugLine="StartActivity(share)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(_share.getObject()));
 //BA.debugLineNum = 519;BA.debugLine="Log( linkplay)";
...
int _i = 0;
int _new_num = 0;
 //BA.debugLineNum = 325;BA.debugLine="Sub Button5_Click";
 //BA.debugLineNum = 326;BA.debugLine="Dim v As Button";
_v = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 327;BA.debugLine="v=Sender";
_v.setObject((android.widget.Button)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA)));
 //BA.debugLineNum = 328;BA.debugLine="cursor1=sql1.ExecQuery(\"SELECT * FROM My_DB\")";
mostCurrent._cursor1.setObject((android.database.Cursor)(mostCurrent._sql1.ExecQuery("SELECT * FROM My_DB")));
 //BA.debugLineNum = 329;BA.debugLine="For i=0 To cursor1.RowCount-1";
{
final int step4 = 1;
final int limit4 = (int) (mostCurrent._cursor1.getRowCount()-1);
_i = (int) (0) ;
for (;(step4 > 0 && _i <= limit4) || (step4 < 0 && _i >= limit4) ;_i = ((int)(0 + _i + step4))  ) {
 //BA.debugLineNum = 330;BA.debugLine="cursor1.Position=i";
mostCurrent._cursor1.setPosition(_i);
 //BA.debugLineNum = 331;BA.debugLine="LogColor(i,Colors.red)";
anywheresoftware.b4a.keywords.Common.LogColor(BA.NumberToString(_i),anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 332;BA.debugLine="If cursor1.GetString(\"artist\")=w Then";
if ((mostCurrent._cursor1.GetString("artist")).equals(mostCurrent._w)) { 
 //BA.debugLineNum = 333;BA.debugLine="chk=2";
_chk = (int) (2);
 //BA.debugLineNum = 334;BA.debugLine="LogColor(i,Colors.Blue)";
anywheresoftware.b4a.keywords.Common.LogColor(BA.NumberToString(_i),anywheresoftware.b4a.keywords.Common.Colors.Blue);
 };
 }
};
 //BA.debugLineNum = 339;BA.debugLine="If chk=2 Then";
if (_chk==2) { 
 //BA.debugLineNum = 340;BA.debugLine="chk=0";
_chk = (int) (0);
 //BA.debugLineNum = 341;BA.debugLine="ToastMessageShow(\"از قبل در لیست علاقه مندیها قر";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("از قبل در لیست علاقه مندیها قرار گرفته است"),anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 343;BA.debugLine="ToastMessageShow(\"به لیست علاقمندی اضافه شد\",Fal";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("به لیست علاقمندی اضافه شد"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 344;BA.debugLine="cursor1=sql1.ExecQuery(\"SELECT id FROM My_DB\")";
mostCurrent._cursor1.setObject((android.database.Cursor)(mostCurrent._sql1.ExecQuery("SELECT id FROM My_DB")));
 //BA.debugLineNum = 345;BA.debugLine="If cursor1.RowCount>0 Then";
...
for (;(step19 > 0 && _i <= limit19) || (step19 < 0 && _i >= limit19) ;_i = ((int)(0 + _i + step19))  ) {
 //BA.debugLineNum = 347;BA.debugLine="cursor1.Position=i";
mostCurrent._cursor1.setPosition(_i);
 //BA.debugLineNum = 348;BA.debugLine="Dim new_num As Int";
_new_num = 0;
 //BA.debugLineNum = 349;BA.debugLine="new_num=cursor1.GetInt(\"id\")";
_new_num = mostCurrent._cursor1.GetInt("id");
 }
};
 };
 //BA.debugLineNum = 352;BA.debugLine="new_num=new_num+1";
_new_num = (int) (_new_num+1);
 //BA.debugLineNum = 353;BA.debugLine="sql1.ExecNonQuery(\"INSERT INTO My_DB VALUES('\" &";
...
anywheresoftware.b4a.objects.collections.Map _links = null;
 //BA.debugLineNum = 254;BA.debugLine="Private Sub download(Imagex As ImageView,link As S";
 //BA.debugLineNum = 255;BA.debugLine="Dim links As Map";
_links = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 256;BA.debugLine="links.Initialize";
_links.Initialize();
 //BA.debugLineNum = 257;BA.debugLine="links.Put(Imagex,link)";
_links.Put((Object)(_imagex.getObject()),(Object)(_link));
 //BA.debugLineNum = 258;BA.debugLine="CallSubDelayed2(ImageDownloader, \"Download\", link";
...
public static String  _imageview3_click() throws Exception{
 //BA.debugLineNum = 444;BA.debugLine="Sub ImageView3_Click";
 //BA.debugLineNum = 446;BA.debugLine="StartActivity(Main)";
...
public static String  _imageview4_click() throws Exception{
 //BA.debugLineNum = 435;BA.debugLine="Sub ImageView4_Click";
 //BA.debugLineNum = 436;BA.debugLine="StartActivity(doomadi)";
...
public static String  _imageview5_click() throws Exception{
 //BA.debugLineNum = 429;BA.debugLine="Sub ImageView5_Click";
 //BA.debugLineNum = 430;BA.debugLine="StartActivity(ostan)";
...
public static String  _imageview6_click() throws Exception{
 //BA.debugLineNum = 423;BA.debugLine="Sub ImageView6_Click";
 //BA.debugLineNum = 424;BA.debugLine="StartActivity(tamas)";
...
if (_job._success==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 149;BA.debugLine="Select Case job.JobName";
...
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 155;BA.debugLine="list.Initialize";
mostCurrent._list.Initialize();
 //BA.debugLineNum = 156;BA.debugLine="Dim res As String";
_res = "";
 //BA.debugLineNum = 157;BA.debugLine="res = job.GetString";
_res = _job._getstring();
 //BA.debugLineNum = 158;BA.debugLine="josn.Initialize(res)";
mostCurrent._josn.Initialize(_res);
 //BA.debugLineNum = 159;BA.debugLine="list=josn.NextArray";
mostCurrent._list = mostCurrent._josn.NextArray();
 //BA.debugLineNum = 160;BA.debugLine="For i=0 To list.Size-1";
{
final int step10 = 1;
...
mostCurrent._scrollview1.getPanel().AddView((android.view.View)(mostCurrent._p.getObject()),_left,_top,anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (47),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (43),mostCurrent.activityBA));
 //BA.debugLineNum = 178;BA.debugLine="p.SetVisibleAnimated(600,True)";
mostCurrent._p.SetVisibleAnimated((int) (600),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 179;BA.debugLine="left = left + 49%x";
_left = (int) (_left+anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (49),mostCurrent.activityBA));
 //BA.debugLineNum = 180;BA.debugLine="p.Tag = i";
mostCurrent._p.setTag((Object)(_i));
 //BA.debugLineNum = 181;BA.debugLine="If i Mod 2 = 1 Then";
if (_i%2==1) { 
 //BA.debugLineNum = 182;BA.debugLine="top = top + 44%y";
_top = (int) (_top+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (44),mostCurrent.activityBA));
 //BA.debugLineNum = 183;BA.debugLine="ScrollView1.Panel.Height = top + 50%y";
...
_o = anywheresoftware.b4a.keywords.Common.File.OpenOutput(mostCurrent._dier,mostCurrent._name3,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 201;BA.debugLine="File.Copy2(job.GetInputStream, o)";
anywheresoftware.b4a.keywords.Common.File.Copy2((java.io.InputStream)(_job._getinputstream().getObject()),(java.io.OutputStream)(_o.getObject()));
 //BA.debugLineNum = 202;BA.debugLine="o.Close";
_o.Close();
 //BA.debugLineNum = 203;BA.debugLine="job.Release";
_job._release();
 break; }
case 2: {
 //BA.debugLineNum = 205;BA.debugLine="Dim o As OutputStream";
_o = new anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper();
 //BA.debugLineNum = 206;BA.debugLine="o = File.OpenOutput(dier, Name3, False)";
_o = anywheresoftware.b4a.keywords.Common.File.OpenOutput(mostCurrent._dier,mostCurrent._name3,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 207;BA.debugLine="File.Copy2(job.GetInputStream, o)";
anywheresoftware.b4a.keywords.Common.File.Copy2((java.io.InputStream)(_job._getinputstream().getObject()),(java.io.OutputStream)(_o.getObject()));
 //BA.debugLineNum = 208;BA.debugLine="o.Close";
_o.Close();
 //BA.debugLineNum = 209;BA.debugLine="job.Release";
_job._release();
 //BA.debugLineNum = 210;BA.debugLine="ToastMessageShow(\"فایل دانلود و ذخیره شد\",True";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("فایل دانلود و ذخیره شد"),anywheresoftware.b4a.keywords.Common.True);
 break; }
case 3: {
 //BA.debugLineNum = 217;BA.debugLine="Dim o As OutputStream";
_o = new anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper();
 //BA.debugLineNum = 218;BA.debugLine="o = File.OpenOutput(dier, Name3, False)";
_o = anywheresoftware.b4a.keywords.Common.File.OpenOutput(mostCurrent._dier,mostCurrent._name3,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 219;BA.debugLine="File.Copy2(job.GetInputStream, o)";
anywheresoftware.b4a.keywords.Common.File.Copy2((java.io.InputStream)(_job._getinputstream().getObject()),(java.io.OutputStream)(_o.getObject()));
 //BA.debugLineNum = 220;BA.debugLine="o.Close";
_o.Close();
 //BA.debugLineNum = 221;BA.debugLine="job.Release";
_job._release();
 //BA.debugLineNum = 222;BA.debugLine="no.Cancel(1)";
mostCurrent._no.Cancel((int) (1));
 //BA.debugLineNum = 223;BA.debugLine="ToastMessageShow(\"فایل دانلود و ذخیره شد\",True";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("فایل دانلود و ذخیره شد"),anywheresoftware.b4a.keywords.Common.True);
 break; }
case 4: {
 //BA.debugLineNum = 233;BA.debugLine="If job.GetString.Contains(\"successfully\") = Tr";
if (_job._getstring().contains("successfully")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 235;BA.debugLine="qqq=qqq+1";
mostCurrent._qqq = BA.NumberToString((double)(Double.parseDouble(mostCurrent._qqq))+1);
 //BA.debugLineNum = 237;BA.debugLine="Label2.Text=qqq";
mostCurrent._label2.setText(BA.ObjectToCharSequence(mostCurrent._qqq));
 //BA.debugLineNum = 238;BA.debugLine="ToastMessageShow(\"بازدیدی دیگر از این آهنگ\",F";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("بازدیدی دیگر از این آهنگ"),anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 242;BA.debugLine="ToastMessageShow(\"اشکالی به وجود امده\",False)";
...
;
 ...
 //BA.debugLineNum = 248;BA.debugLine="ToastMessageShow(http.ErrorMessage,True)";
...
public static String  _label3_click() throws Exception{
 //BA.debugLineNum = 440;BA.debugLine="Sub Label3_Click";
 //BA.debugLineNum = 441;BA.debugLine="StartActivity(a)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._a.getObject()));
 //BA.debugLineNum = 442;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 443;BA.debugLine="End Sub";
return "";
}
public static String  _loaddb(String _db) throws Exception{
 //BA.debugLineNum = 143;BA.debugLine="Sub LoadDB(DB As String)";
 //BA.debugLineNum = 144;BA.debugLine="http.PostString(\"http://doholi.com/muzzik/json.ph";
...
int _i = 0;
int _new_num = 0;
 //BA.debugLineNum = 291;BA.debugLine="Sub p_LongClick";
 //BA.debugLineNum = 292;BA.debugLine="Dim v As Panel";
_v = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 293;BA.debugLine="v=Sender";
_v.setObject((android.view.ViewGroup)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA)));
 //BA.debugLineNum = 294;BA.debugLine="cursor1=sql1.ExecQuery(\"SELECT * FROM My_DB\")";
mostCurrent._cursor1.setObject((android.database.Cursor)(mostCurrent._sql1.ExecQuery("SELECT * FROM My_DB")));
 //BA.debugLineNum = 295;BA.debugLine="For i=0 To cursor1.RowCount-1";
{
final int step4 = 1;
final int limit4 = (int) (mostCurrent._cursor1.getRowCount()-1);
_i = (int) (0) ;
for (;(step4 > 0 && _i <= limit4) || (step4 < 0 && _i >= limit4) ;_i = ((int)(0 + _i + step4))  ) {
 //BA.debugLineNum = 296;BA.debugLine="cursor1.Position=i";
mostCurrent._cursor1.setPosition(_i);
 //BA.debugLineNum = 297;BA.debugLine="LogColor(i,Colors.red)";
anywheresoftware.b4a.keywords.Common.LogColor(BA.NumberToString(_i),anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 298;BA.debugLine="If cursor1.GetString(\"artist\")=Artist.Get(v.Tag)";
if ((mostCurrent._cursor1.GetString("artist")).equals(BA.ObjectToString(mostCurrent._artist.Get((int)(BA.ObjectToNumber(_v.getTag())))))) { 
 //BA.debugLineNum = 299;BA.debugLine="chk=2";
_chk = (int) (2);
 //BA.debugLineNum = 300;BA.debugLine="LogColor(i,Colors.Blue)";
anywheresoftware.b4a.keywords.Common.LogColor(BA.NumberToString(_i),anywheresoftware.b4a.keywords.Common.Colors.Blue);
 };
 }
};
 //BA.debugLineNum = 305;BA.debugLine="If chk=2 Then";
if (_chk==2) { 
 //BA.debugLineNum = 306;BA.debugLine="chk=0";
_chk = (int) (0);
 //BA.debugLineNum = 307;BA.debugLine="ToastMessageShow(\"از قبل در لیست علاقه مندیها قر";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("از قبل در لیست علاقه مندیها قرار گرفته است"),anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 309;BA.debugLine="ToastMessageShow(\"به لیست علاقمندی اضافه شد\",Fal";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("به لیست علاقمندی اضافه شد"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 310;BA.debugLine="cursor1=sql1.ExecQuery(\"SELECT id FROM My_DB\")";
mostCurrent._cursor1.setObject((android.database.Cursor)(mostCurrent._sql1.ExecQuery("SELECT id FROM My_DB")));
 //BA.debugLineNum = 311;BA.debugLine="If cursor1.RowCount>0 Then";
if (mostCurrent._cursor1.getRowCount()>0) { 
 //BA.debugLineNum = 312;BA.debugLine="For i=0 To cursor1.RowCount-1";
{
final int step19 = 1;
final int limit19 = (int) (mostCurrent._cursor1.getRowCount()-1);
_i = (int) (0) ;
...
mostCurrent._cursor1.setPosition(_i);
 //BA.debugLineNum = 314;BA.debugLine="Dim new_num As Int";
_new_num = 0;
 //BA.debugLineNum = 315;BA.debugLine="new_num=cursor1.GetInt(\"id\")";
_new_num = mostCurrent._cursor1.GetInt("id");
 }
};
 };
 //BA.debugLineNum = 318;BA.debugLine="new_num=new_num+1";
_new_num = (int) (_new_num+1);
 //BA.debugLineNum = 319;BA.debugLine="sql1.ExecNonQuery(\"INSERT INTO My_DB VALUES('\" &";
mostCurrent._sql1.ExecNonQuery("INSERT INTO My_DB VALUES('"+BA.NumberToString(_new_num)+"','"+mostCurrent._w+"','"+mostCurrent._ww+"','"+mostCurrent._www+"','"+mostCurrent._linkplay+"','"+mostCurrent._sahr11+"','"+mostCurrent._telegram2+"','"+mostCurrent._linkplay+"','"+mostCurrent._qqq+"')");
 };
...
public static String  _panel1_touch(int _action,float _x,float _y) throws Exception{
 //BA.debugLineNum = 419;BA.debugLine="Sub Panel1_Touch (Action As Int, X As Float, Y As";
 //BA.debugLineNum = 421;BA.debugLine="End Sub";
return "";
}
public static String  _pause_click() throws Exception{
 //BA.debugLineNum = 394;BA.debugLine="Sub pause_Click";
 //BA.debugLineNum = 395;BA.debugLine="ToastMessageShow(\"توقف\",  True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("توقف"),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 396;BA.debugLine="If isplaying=True Then";
if (_isplaying==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 397;BA.debugLine="music.pause";
mostCurrent._music.pause();
 //BA.debugLineNum = 398;BA.debugLine="isplaying=True";
_isplaying = anywheresoftware.b4a.keywords.Common.True;
 };
 //BA.debugLineNum = 401;BA.debugLine="Try";
try { //BA.debugLineNum = 403;BA.debugLine="sound.Load(File.DirRootExternal & \"/doholi/music";
mostCurrent._sound.Load(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/doholi/music",mostCurrent._ss);
 //BA.debugLineNum = 404;BA.debugLine="sound.Looping=False";
mostCurrent._sound.setLooping(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 405;BA.debugLine="sound.Stop";
mostCurrent._sound.Stop();
 } 
       catch (Exception e11) {
			processBA.setLastException(e11); //BA.debugLineNum = 408;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)));
 };
...
anywheresoftware.b4a.samples.httputils2.httpjob _edit = null;
 //BA.debugLineNum = 357;BA.debugLine="Sub play_Click";
 //BA.debugLineNum = 358;BA.debugLine="asa =qqq + 1";
_asa = (int) ((double)(Double.parseDouble(mostCurrent._qqq))+1);
 //BA.debugLineNum = 359;BA.debugLine="Log(asa)";
anywheresoftware.b4a.keywords.Common.Log(BA.NumberToString(_asa));
 //BA.debugLineNum = 360;BA.debugLine="DoEvents";
anywheresoftware.b4a.keywords.Common.DoEvents();
 //BA.debugLineNum = 361;BA.debugLine="Dim edit As HttpJob";
_edit = new anywheresoftware.b4a.samples.httputils2.httpjob();
 //BA.debugLineNum = 362;BA.debugLine="edit.Initialize(\"edit\",Me)";
_edit._initialize(processBA,"edit",alavivahid.getObject());
 //BA.debugLineNum = 363;BA.debugLine="edit.PostString(\"http://doholi.com/edit/edit17.ph";
_edit._poststring("http://doholi.com/edit/edit17.php","VEIW="+BA.NumberToString(_asa)+"&id="+mostCurrent._qqqq);
 //BA.debugLineNum = 365;BA.debugLine="s=Regex.Split(\"/\",linkplay)";
mostCurrent._s = anywheresoftware.b4a.keywords.Common.Regex.Split("/",mostCurrent._linkplay);
 //BA.debugLineNum = 367;BA.debugLine="ss=s(5)";
mostCurrent._ss = mostCurrent._s[(int) (5)];
 //BA.debugLineNum = 368;BA.debugLine="If File.Exists(File.DirRootExternal & \"/doholi/mu";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/doholi/music",mostCurrent._ss)==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 370;BA.debugLine="If isplaying=False Then";
if (_isplaying==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 371;BA.debugLine="music.Create(linkplay)";
mostCurrent._music.Create(processBA,mostCurrent._linkplay);
 //BA.debugLineNum = 372;BA.debugLine="music.Play";
mostCurrent._music.Play();
 //BA.debugLineNum = 373;BA.debugLine="timer1.Initialize(\"t\",5)";
...
mostCurrent._timer1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 375;BA.debugLine="isplaying=True";
_isplaying = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 376;BA.debugLine="SeekBar1.Visible=True";
mostCurrent._seekbar1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 }else {
 //BA.debugLineNum = 378;BA.debugLine="music.Play";
mostCurrent._music.Play();
 //BA.debugLineNum = 379;BA.debugLine="isplaying=True";
_isplaying = anywheresoftware.b4a.keywords.Common.True;
 };
 }else {
 //BA.debugLineNum = 384;BA.debugLine="ToastMessageShow(\"فایل موجود است\",  True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("فایل موجود است"),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 385;BA.debugLine="Dim sound As MediaPlayer";
mostCurrent._sound = new anywheresoftware.b4a.objects.MediaPlayerWrapper();
 //BA.debugLineNum = 386;BA.debugLine="sound.Initialize2(\"\")";
mostCurrent._sound.Initialize2(processBA,"");
 //BA.debugLineNum = 387;BA.debugLine="sound.Load(File.DirRootExternal & \"/doholi/music";
mostCurrent._sound.Load(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/doholi/music",mostCurrent._ss);
 //BA.debugLineNum = 388;BA.debugLine="sound.Looping=False";
mostCurrent._sound.setLooping(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 389;BA.debugLine="sound.Play";
...
public static String  _t_tick() throws Exception{
 //BA.debugLineNum = 412;BA.debugLine="Sub t_Tick";
 //BA.debugLineNum = 414;BA.debugLine="time.Text=music.PlayingTime";
mostCurrent._time.setText(BA.ObjectToCharSequence(mostCurrent._music.PlayingTime()));
 //BA.debugLineNum = 415;BA.debugLine="timer1.Enabled=True";
mostCurrent._timer1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 417;BA.debugLine="End Sub";
return "";
}
public static String  _tin_tick() throws Exception{
 //BA.debugLineNum = 522;BA.debugLine="Sub tin_Tick";
 //BA.debugLineNum = 523;BA.debugLine="ImageView1.SetBackgroundImage(Null)";
mostCurrent._imageview1.SetBackgroundImageNew((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 525;BA.debugLine="tin.Enabled=False";
