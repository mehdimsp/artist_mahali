...
public class gonabad extends Activity implements B4AActivity{
	public static gonabad mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.doomadi.artist", "com.doomadi.artist.gonabad");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (gonabad).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.doomadi.artist", "com.doomadi.artist.gonabad");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.doomadi.artist.gonabad", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (gonabad) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (gonabad) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (gonabad) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._scrollview1.getPanel().setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (120),mostCurrent.activityBA));
 //BA.debugLineNum = 19;BA.debugLine="ostanha.Button(Button1,\"رجب زاده\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button1,"رجب زاده");
...
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 76;BA.debugLine="StartActivity(\"razavi\")";
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 59;BA.debugLine="StartActivity(rajabzadeh)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._rajabzadeh.getObject()));
...
public static String  _imageview1_click() throws Exception{
 //BA.debugLineNum = 31;BA.debugLine="Sub ImageView1_Click";
...
public static String  _imageview2_click() throws Exception{
 //BA.debugLineNum = 37;BA.debugLine="Sub ImageView2_Click";
 //BA.debugLineNum = 38;BA.debugLine="StartActivity(doomadi)";
...
public static String  _imageview3_click() throws Exception{
 //BA.debugLineNum = 41;BA.debugLine="Sub ImageView3_Click";
 //BA.debugLineNum = 44;BA.debugLine="StartActivity(ostan)";
...
public static String  _imageview4_click() throws Exception{
 //BA.debugLineNum = 48;BA.debugLine="Sub ImageView4_Click";
 //BA.debugLineNum = 51;BA.debugLine="StartActivity(tamas)";
