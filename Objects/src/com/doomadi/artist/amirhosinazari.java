...
public class amirhosinazari extends Activity implements B4AActivity{
	public static amirhosinazari mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.doomadi.artist", "com.doomadi.artist.amirhosinazari");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (amirhosinazari).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.doomadi.artist", "com.doomadi.artist.amirhosinazari");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.doomadi.artist.amirhosinazari", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (amirhosinazari) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (amirhosinazari) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (amirhosinazari) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._http._initialize(processBA,"http",amirhosinazari.getObject());
 //BA.debugLineNum = 102;BA.debugLine="LoadDB(\"SELECT * FROM amirhosiynazari ORDER BY id";
_loaddb("SELECT * FROM amirhosiynazari ORDER BY id DESC LIMIT 0,10000000000000");
...
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 612;BA.debugLine="StartActivity(azsharghi)";
...
mostCurrent._http._initialize(processBA,"job3",amirhosinazari.getObject());
...
_edit._initialize(processBA,"edit",amirhosinazari.getObject());
 //BA.debugLineNum = 374;BA.debugLine="edit.PostString(\"http://doholi.com/edit2/edit57.p";
_edit._poststring("http://doholi.com/edit2/edit57.php","VEIW="+BA.NumberToString(_asa)+"&id="+mostCurrent._qqqq);
