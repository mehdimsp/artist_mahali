...
public class rajabzadeh extends Activity implements B4AActivity{
	public static rajabzadeh mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.doomadi.artist", "com.doomadi.artist.rajabzadeh");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (rajabzadeh).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.doomadi.artist", "com.doomadi.artist.rajabzadeh");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.doomadi.artist.rajabzadeh", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (rajabzadeh) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (rajabzadeh) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (rajabzadeh) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._http._initialize(processBA,"http",rajabzadeh.getObject());
 //BA.debugLineNum = 102;BA.debugLine="LoadDB(\"SELECT * FROM rajabzadeh ORDER BY id DESC";
_loaddb("SELECT * FROM rajabzadeh ORDER BY id DESC LIMIT 0,10000000000000");
...
String _str = "";
 //BA.debugLineNum = 555;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
 //BA.debugLineNum = 556;BA.debugLine="If KeyCode=KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 557;BA.debugLine="If Panel1.Visible=True Then";
if (mostCurrent._panel1.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 558;BA.debugLine="If isplaying=True Then";
if (_isplaying==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 559;BA.debugLine="Dim str As String";
_str = "";
 //BA.debugLineNum = 560;BA.debugLine="str=Msgbox2(\"موزیک در حال پخش قطع شود؟؟\",\"doom";
...
if (true) return anywheresoftware.b4a.keywords.Common.True;
 ...
 //BA.debugLineNum = 585;BA.debugLine="ImageView6.Visible=True";
mostCurrent._imageview6.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 587;BA.debugLine="ImageView5.Visible=True";
mostCurrent._imageview5.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 589;BA.debugLine="ImageView4.Visible=True";
mostCurrent._imageview4.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 591;BA.debugLine="ImageView3.Visible=True";
mostCurrent._imageview3.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 596;BA.debugLine="Panel1.SetVisibleAnimated(500,False)";
mostCurrent._panel1.SetVisibleAnimated((int) (500),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 597;BA.debugLine="tin.Initialize(\"tin\",500)";
mostCurrent._tin.Initialize(processBA,"tin",(long) (500));
 //BA.debugLineNum = 598;BA.debugLine="tin.Enabled=True";
mostCurrent._tin.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 };
...
if (true) return anywheresoftware.b4a.keywords.Common.True;
 ...
 //BA.debugLineNum = 606;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 609;BA.debugLine="StartActivity(gonabad)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._gonabad.getObject()));
 //BA.debugLineNum = 610;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 611;BA.debugLine="Return True";
if (true) return anywheresoftware.b4a.keywords.Common.True;
 };
...
anywheresoftware.b4a.objects.IntentWrapper _i2 = null;
 //BA.debugLineNum = 466;BA.debugLine="Sub Button1_Click";
 //BA.debugLineNum = 468;BA.debugLine="Try";
try { //BA.debugLineNum = 470;BA.debugLine="Dim far As Intent";
_far = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 471;BA.debugLine="Dim pm As PackageManager";
_pm = new anywheresoftware.b4a.phone.PackageManagerWrapper();
 //BA.debugLineNum = 472;BA.debugLine="far=pm.GetApplicationIntent(\"com.hanista.mobogra";
_far = _pm.GetApplicationIntent("com.hanista.mobogram");
 //BA.debugLineNum = 473;BA.debugLine="If far.IsInitialized Then";
if (_far.IsInitialized()) { 
 //BA.debugLineNum = 475;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 476;BA.debugLine="i.Initialize(i.ACTION_VIEW, \"http://telegram.me";
_i.Initialize(_i.ACTION_VIEW,"http://telegram.me/"+mostCurrent._telegram2);
 //BA.debugLineNum = 477;BA.debugLine="Dim jo As JavaObject = i";
_jo = new anywheresoftware.b4j.object.JavaObject();
_jo.setObject((java.lang.Object)(_i.getObject()));
 //BA.debugLineNum = 478;BA.debugLine="jo.RunMethod(\"setPackage\", Array As Object(\"com";
_jo.RunMethod("setPackage",new Object[]{(Object)("com.hanista.mobogram")});
 //BA.debugLineNum = 479;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(_i.getObject()));
 }else {
 //BA.debugLineNum = 486;BA.debugLine="Dim i2 As Intent";
_i2 = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 487;BA.debugLine="i2.initialize (i2.action_view,\"tg://resolve?dom";
_i2.Initialize(_i2.ACTION_VIEW,"tg://resolve?domain="+mostCurrent._telegram2);
 //BA.debugLineNum = 488;BA.debugLine="StartActivity (i2)";
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 498;BA.debugLine="Sub Button2_Click";
 //BA.debugLineNum = 499;BA.debugLine="Try";
try { //BA.debugLineNum = 500;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 501;BA.debugLine="i.Initialize(i.ACTION_VIEW,LINK2)";
_i.Initialize(_i.ACTION_VIEW,mostCurrent._link2);
 //BA.debugLineNum = 502;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(_i.getObject()));
 } 
       catch (Exception e6) {
			processBA.setLastException(e6); //BA.debugLineNum = 504;BA.debugLine="Log(LastException)";
...
public static String  _button3_click() throws Exception{
 //BA.debugLineNum = 508;BA.debugLine="Sub Button3_Click";
 //BA.debugLineNum = 510;BA.debugLine="s=Regex.Split(\"/\",linkplay)";
mostCurrent._s = anywheresoftware.b4a.keywords.Common.Regex.Split("/",mostCurrent._linkplay);
 //BA.debugLineNum = 512;BA.debugLine="ss=s(5)";
mostCurrent._ss = mostCurrent._s[(int) (5)];
 //BA.debugLineNum = 513;BA.debugLine="If File.Exists(File.DirRootExternal & \"/doholimus";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/doholimusic",mostCurrent._ss)==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 514;BA.debugLine="Name3= ss";
mostCurrent._name3 = mostCurrent._ss;
 //BA.debugLineNum = 515;BA.debugLine="dier=File.DirRootExternal& \"/doholimusic\"";
mostCurrent._dier = anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/doholimusic";
 //BA.debugLineNum = 518;BA.debugLine="http.Initialize(\"job3\",Me)";
mostCurrent._http._initialize(processBA,"job3",rajabzadeh.getObject());
 //BA.debugLineNum = 519;BA.debugLine="http.Download(linkplay)";
mostCurrent._http._download(mostCurrent._linkplay);
 //BA.debugLineNum = 521;BA.debugLine="no.Initialize";
mostCurrent._no.Initialize();
 //BA.debugLineNum = 522;BA.debugLine="no.Icon=\"icon\"";
mostCurrent._no.setIcon("icon");
 //BA.debugLineNum = 523;BA.debugLine="no.Light=False";
mostCurrent._no.setLight(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 524;BA.debugLine="no.Vibrate = False";
mostCurrent._no.setVibrate(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 525;BA.debugLine="no.sound = True";
mostCurrent._no.setSound(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 526;BA.debugLine="no.AutoCancel=True";
mostCurrent._no.setAutoCancel(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 527;BA.debugLine="no.OnGoingEvent=True";
mostCurrent._no.setOnGoingEvent(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 528;BA.debugLine="no.SetInfo(\"در حال دانلود\",Name3,Null)";
mostCurrent._no.SetInfo(processBA,"در حال دانلود",mostCurrent._name3,anywheresoftware.b4a.keywords.Common.Null);
 //BA.debugLineNum = 529;BA.debugLine="no.Notify(1)";
mostCurrent._no.Notify((int) (1));
 //BA.debugLineNum = 530;BA.debugLine="ProgressDialogShow(\"در حال دانلود فایل...صبر کنی";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,BA.ObjectToCharSequence("در حال دانلود فایل...صبر کنید"));
 //BA.debugLineNum = 531;BA.debugLine="ToastMessageShow(\"لطفا منتظر بمانید,\",  True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("لطفا منتظر بمانید,"),anywheresoftware.b4a.keywords.Common.True);
 ...
 //BA.debugLineNum = 533;BA.debugLine="ToastMessageShow(\"فایل موجود است\",  True)";
...
anywheresoftware.b4a.objects.IntentWrapper _share = null;
 //BA.debugLineNum = 537;BA.debugLine="Sub Button4_Click";
 //BA.debugLineNum = 539;BA.debugLine="Dim share As Intent";
_share = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 540;BA.debugLine="share.Initialize(share.ACTION_SEND,\"\")";
_share.Initialize(_share.ACTION_SEND,"");
 //BA.debugLineNum = 542;BA.debugLine="share.SetType(\"text/plain\")";
_share.SetType("text/plain");
 //BA.debugLineNum = 543;BA.debugLine="share.PutExtra(\"android.intent.extra.TEXT\", linkp";
_share.PutExtra("android.intent.extra.TEXT",(Object)(mostCurrent._linkplay));
 //BA.debugLineNum = 544;BA.debugLine="share.WrapAsIntentChooser(\"اشتراک گذاری آهنگ\")";
_share.WrapAsIntentChooser("اشتراک گذاری آهنگ");
 //BA.debugLineNum = 545;BA.debugLine="StartActivity(share)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(_share.getObject()));
 //BA.debugLineNum = 546;BA.debugLine="Log( linkplay)";
...
public static String  _imageview3_click() throws Exception{
 //BA.debugLineNum = 459;BA.debugLine="Sub ImageView3_Click";
 //BA.debugLineNum = 461;BA.debugLine="StartActivity(Main)";
...
public static String  _imageview4_click() throws Exception{
 //BA.debugLineNum = 450;BA.debugLine="Sub ImageView4_Click";
 //BA.debugLineNum = 451;BA.debugLine="StartActivity(doomadi)";
...
public static String  _label3_click() throws Exception{
 //BA.debugLineNum = 455;BA.debugLine="Sub Label3_Click";
 //BA.debugLineNum = 456;BA.debugLine="StartActivity(a)";
...
_edit._initialize(processBA,"edit",rajabzadeh.getObject());
 //BA.debugLineNum = 374;BA.debugLine="edit.PostString(\"http://doholi.com/edit/edit39.ph";
_edit._poststring("http://doholi.com/edit/edit39.php","VEIW="+BA.NumberToString(_asa)+"&id="+mostCurrent._qqqq);
...
public static String  _tin_tick() throws Exception{
 //BA.debugLineNum = 550;BA.debugLine="Sub tin_Tick";
 //BA.debugLineNum = 551;BA.debugLine="ImageView1.SetBackgroundImage(Null)";
mostCurrent._imageview1.SetBackgroundImageNew((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 553;BA.debugLine="tin.Enabled=False";
