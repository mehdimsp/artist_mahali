...
public class tehran extends Activity implements B4AActivity{
	public static tehran mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.doomadi.artist", "com.doomadi.artist.tehran");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (tehran).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.doomadi.artist", "com.doomadi.artist.tehran");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.doomadi.artist.tehran", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (tehran) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (tehran) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (tehran) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._scrollview1.getPanel().setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (120),mostCurrent.activityBA));
 //BA.debugLineNum = 22;BA.debugLine="ostanha.Button(Button1,\"حسین یوسف\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button1,"حسین یوسف");
 //BA.debugLineNum = 23;BA.debugLine="ostanha.Button(Button2,\"سیاوش یوسفی\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button2,"سیاوش یوسفی");
 //BA.debugLineNum = 24;BA.debugLine="ostanha.Button(Button3,\"یاسر محمودی\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button3,"یاسر محمودی");
...
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 90;BA.debugLine="StartActivity(\"ostan\")";
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 65;BA.debugLine="StartActivity(yousof)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._yousof.getObject()));
...
public static String  _button2_click() throws Exception{
 ...
 //BA.debugLineNum = 70;BA.debugLine="StartActivity(siyavashyosofi)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._siyavashyosofi.getObject()));
...
public static String  _button3_click() throws Exception{
 ...
 //BA.debugLineNum = 76;BA.debugLine="StartActivity(yasermahmoodi)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._yasermahmoodi.getObject()));
...
public static String  _button4_click() throws Exception{
 ...
 //BA.debugLineNum = 82;BA.debugLine="Msgbox(\"اگر نام شما در لیست نیست از قسمت ارتباط ب";
...
public static String  _imageview1_click() throws Exception{
 //BA.debugLineNum = 39;BA.debugLine="Sub ImageView1_Click";
...
public static String  _imageview2_click() throws Exception{
 //BA.debugLineNum = 45;BA.debugLine="Sub ImageView2_Click";
 //BA.debugLineNum = 46;BA.debugLine="StartActivity(doomadi)";
...
public static String  _imageview3_click() throws Exception{
 //BA.debugLineNum = 49;BA.debugLine="Sub ImageView3_Click";
 //BA.debugLineNum = 52;BA.debugLine="StartActivity(ostan)";
...
public static String  _imageview4_click() throws Exception{
 //BA.debugLineNum = 56;BA.debugLine="Sub ImageView4_Click";
 //BA.debugLineNum = 59;BA.debugLine="StartActivity(tamas)";
