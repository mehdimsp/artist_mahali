...
public class tamas extends Activity implements B4AActivity{
	public static tamas mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.doomadi.artist", "com.doomadi.artist.tamas");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (tamas).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.doomadi.artist", "com.doomadi.artist.tamas");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.doomadi.artist.tamas", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (tamas) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (tamas) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (tamas) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 20;BA.debugLine="Activity.LoadLayout(\"tamas\")";
mostCurrent._activity.LoadLayout("tamas",mostCurrent.activityBA);
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 ...
 //BA.debugLineNum = 32;BA.debugLine="Private i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 33;BA.debugLine="i.Initialize(i.ACTION_VIEW,\"http://telegram.me/mu";
_i.Initialize(_i.ACTION_VIEW,"http://telegram.me/music_mahali");
 //BA.debugLineNum = 34;BA.debugLine="StartActivity(i)";
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 37;BA.debugLine="Sub Button2_Click";
 //BA.debugLineNum = 38;BA.debugLine="Private i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 39;BA.debugLine="i.Initialize(i.ACTION_VIEW,\"https://www.instagram";
_i.Initialize(_i.ACTION_VIEW,"https://www.instagram.com/doomadi");
 //BA.debugLineNum = 40;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(_i.getObject()));
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 ...
 //BA.debugLineNum = 44;BA.debugLine="Private i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 45;BA.debugLine="i.Initialize(i.ACTION_VIEW,\"https://sapp.ir/dooma";
_i.Initialize(_i.ACTION_VIEW,"https://sapp.ir/doomade");
 //BA.debugLineNum = 46;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(_i.getObject()));
...
public static String  _imageview1_click() throws Exception{
 //BA.debugLineNum = 54;BA.debugLine="Sub ImageView1_Click";
...
public static String  _imageview2_click() throws Exception{
 //BA.debugLineNum = 60;BA.debugLine="Sub ImageView2_Click";
 //BA.debugLineNum = 61;BA.debugLine="StartActivity(doomadi)";
...
public static String  _imageview3_click() throws Exception{
 //BA.debugLineNum = 64;BA.debugLine="Sub ImageView3_Click";
 //BA.debugLineNum = 66;BA.debugLine="StartActivity(ostanha)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._ostanha.getObject()));
...
public static String  _imageview4_click() throws Exception{
 //BA.debugLineNum = 72;BA.debugLine="Sub ImageView4_Click";
