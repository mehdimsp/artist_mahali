...
public class razavi extends Activity implements B4AActivity{
	public static razavi mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.doomadi.artist", "com.doomadi.artist.razavi");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (razavi).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.doomadi.artist", "com.doomadi.artist.razavi");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.doomadi.artist.razavi", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (razavi) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (razavi) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (razavi) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 19;BA.debugLine="Activity.LoadLayout(\"scrol\")";
mostCurrent._activity.LoadLayout("scrol",mostCurrent.activityBA);
 //BA.debugLineNum = 20;BA.debugLine="ScrollView1.Panel.LoadLayout(\"shahr\")";
mostCurrent._scrollview1.getPanel().LoadLayout("shahr",mostCurrent.activityBA);
 //BA.debugLineNum = 21;BA.debugLine="ScrollView1.Panel.Height = 120%y";
mostCurrent._scrollview1.getPanel().setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (120),mostCurrent.activityBA));
 //BA.debugLineNum = 22;BA.debugLine="ostanha.Button(Button1,\"مشهد\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button1,"مشهد");
 //BA.debugLineNum = 23;BA.debugLine="ostanha.Button(Button2,\"سبزوار\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button2,"سبزوار");
 //BA.debugLineNum = 24;BA.debugLine="ostanha.Button(Button3,\"نیشابور\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button3,"نیشابور");
 //BA.debugLineNum = 25;BA.debugLine="ostanha.Button(Button4,\"کاشمر\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button4,"کاشمر");
 //BA.debugLineNum = 26;BA.debugLine="ostanha.Button(Button5,\"تربت حیدریه\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button5,"تربت حیدریه");
 //BA.debugLineNum = 27;BA.debugLine="ostanha.Button(Button6,\"قوچان\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button6,"قوچان");
 //BA.debugLineNum = 28;BA.debugLine="ostanha.Button(Button7,\"گناباد\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button7,"گناباد");
 //BA.debugLineNum = 29;BA.debugLine="ostanha.Button(Button8,\"تربت جام\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button8,"تربت جام");
 //BA.debugLineNum = 30;BA.debugLine="ostanha.Button(Button9,\"بجستان و محولات\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button9,"بجستان و محولات");
...
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 122;BA.debugLine="StartActivity(\"ostan\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ostan"));
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 70;BA.debugLine="StartActivity(mashhad)";
...
public static String  _button2_click() throws Exception{
 ...
 //BA.debugLineNum = 76;BA.debugLine="StartActivity(sabzevar)";
...
public static String  _button3_click() throws Exception{
 ...
 //BA.debugLineNum = 81;BA.debugLine="StartActivity(neyshboor)";
...
public static String  _button4_click() throws Exception{
 //BA.debugLineNum = 86;BA.debugLine="Sub Button4_Click";
 //BA.debugLineNum = 88;BA.debugLine="StartActivity(kashmar)";
...
public static String  _button5_click() throws Exception{
 //BA.debugLineNum = 91;BA.debugLine="Sub Button5_Click";
 //BA.debugLineNum = 93;BA.debugLine="StartActivity(torbat)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._torbat.getObject()));
...
public static String  _button7_click() throws Exception{
 //BA.debugLineNum = 97;BA.debugLine="Sub Button7_Click";
 //BA.debugLineNum = 99;BA.debugLine="StartActivity(gonabad)";
...
public static String  _button8_click() throws Exception{
 ...
 //BA.debugLineNum = 106;BA.debugLine="StartActivity(torbatjam)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._torbatjam.getObject()));
...
public static String  _button9_click() throws Exception{
 //BA.debugLineNum = 109;BA.debugLine="Sub Button9_Click";
 //BA.debugLineNum = 111;BA.debugLine="StartActivity(bejstan)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._bejstan.getObject()));
...
mostCurrent._button10 = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 13;BA.debugLine="Private Button11, Button12, Button14, Button15, B";
...
mostCurrent._button20 = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 14;BA.debugLine="Private Button21, Button22, Button23, Button24 ,";
...
public static String  _imageview1_click() throws Exception{
 //BA.debugLineNum = 44;BA.debugLine="Sub ImageView1_Click";
...
public static String  _imageview2_click() throws Exception{
 ...
 //BA.debugLineNum = 51;BA.debugLine="StartActivity(doomadi)";
...
public static String  _imageview3_click() throws Exception{
 //BA.debugLineNum = 54;BA.debugLine="Sub ImageView3_Click";
 //BA.debugLineNum = 57;BA.debugLine="StartActivity(ostan)";
...
public static String  _imageview4_click() throws Exception{
 //BA.debugLineNum = 61;BA.debugLine="Sub ImageView4_Click";
 //BA.debugLineNum = 64;BA.debugLine="StartActivity(tamas)";
