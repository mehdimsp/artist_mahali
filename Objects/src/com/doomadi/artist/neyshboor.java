...
public class neyshboor extends Activity implements B4AActivity{
	public static neyshboor mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.doomadi.artist", "com.doomadi.artist.neyshboor");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (neyshboor).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.doomadi.artist", "com.doomadi.artist.neyshboor");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.doomadi.artist.neyshboor", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (neyshboor) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (neyshboor) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (neyshboor) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._scrollview1.getPanel().LoadLayout("ahang",mostCurrent.activityBA);
 //BA.debugLineNum = 18;BA.debugLine="ScrollView1.Panel.Height = 160%y";
mostCurrent._scrollview1.getPanel().setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (160),mostCurrent.activityBA));
 //BA.debugLineNum = 19;BA.debugLine="ostanha.Button(Button1,\"مرتضی جوان\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button1,"مرتضی جوان");
 //BA.debugLineNum = 20;BA.debugLine="ostanha.Button(Button2,\"وحید سدیدی\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button2,"وحید سدیدی");
 //BA.debugLineNum = 21;BA.debugLine="ostanha.Button(Button3,\"حجت قائمی\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button3,"حجت قائمی");
 //BA.debugLineNum = 22;BA.debugLine="ostanha.Button(Button4,\"میرزاده\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button4,"میرزاده");
...
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 96;BA.debugLine="StartActivity(\"razavi\")";
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 62;BA.debugLine="StartActivity(javan)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._javan.getObject()));
...
public static String  _button2_click() throws Exception{
 ...
 //BA.debugLineNum = 67;BA.debugLine="StartActivity(seydi)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._seydi.getObject()));
...
public static String  _button3_click() throws Exception{
 //BA.debugLineNum = 71;BA.debugLine="Sub Button3_Click";
 //BA.debugLineNum = 72;BA.debugLine="StartActivity(ghaemi)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._ghaemi.getObject()));
...
public static String  _button4_click() throws Exception{
 //BA.debugLineNum = 76;BA.debugLine="Sub Button4_Click";
 //BA.debugLineNum = 77;BA.debugLine="StartActivity(mirzadeh)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._mirzadeh.getObject()));
