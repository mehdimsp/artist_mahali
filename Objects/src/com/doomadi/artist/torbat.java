...
public class torbat extends Activity implements B4AActivity{
	public static torbat mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.doomadi.artist", "com.doomadi.artist.torbat");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (torbat).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.doomadi.artist", "com.doomadi.artist.torbat");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.doomadi.artist.torbat", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (torbat) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (torbat) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (torbat) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._scrollview1.getPanel().setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (160),mostCurrent.activityBA));
 //BA.debugLineNum = 21;BA.debugLine="ostanha.Button(Button1,\"علی اسدیان\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button1,"علی اسدیان");
 //BA.debugLineNum = 22;BA.debugLine="ostanha.Button(Button2,\"ناصر یعقوبی\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button2,"ناصر یعقوبی");
...
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 80;BA.debugLine="StartActivity(\"razavi\")";
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 61;BA.debugLine="StartActivity(asadyan)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._asadyan.getObject()));
...
public static String  _button2_click() throws Exception{
 //BA.debugLineNum = 66;BA.debugLine="Sub Button2_Click";
 //BA.debugLineNum = 68;BA.debugLine="StartActivity(yaghoobi)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._yaghoobi.getObject()));
...
public static String  _button3_click() throws Exception{
 ...
 //BA.debugLineNum = 74;BA.debugLine="Msgbox(\"اگر نام شما در لیست نیست از قسمت ارتباط ب";
