...
public class sistan extends Activity implements B4AActivity{
	public static sistan mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.doomadi.artist", "com.doomadi.artist.sistan");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (sistan).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.doomadi.artist", "com.doomadi.artist.sistan");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.doomadi.artist.sistan", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (sistan) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (sistan) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (sistan) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._scrollview1.getPanel().setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (160),mostCurrent.activityBA));
 //BA.debugLineNum = 21;BA.debugLine="ostanha.Button(Button1,\"عبدل علی\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button1,"عبدل علی");
 //BA.debugLineNum = 22;BA.debugLine="ostanha.Button(Button2,\"عمار\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button2,"عمار");
 //BA.debugLineNum = 23;BA.debugLine="ostanha.Button(Button3,\"وحید ترکش\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button3,"وحید ترکش");
 //BA.debugLineNum = 24;BA.debugLine="ostanha.Button(Button4,\"ساسان رئیسی\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button4,"ساسان رئیسی");
...
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 94;BA.debugLine="StartActivity(\"ostan\")";
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 63;BA.debugLine="StartActivity(aliabdol)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._aliabdol.getObject()));
...
public static String  _button2_click() throws Exception{
 ...
 //BA.debugLineNum = 70;BA.debugLine="StartActivity(ammar)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._ammar.getObject()));
...
public static String  _button3_click() throws Exception{
 ...
 //BA.debugLineNum = 77;BA.debugLine="StartActivity(tarkesh)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._tarkesh.getObject()));
...
public static String  _button4_click() throws Exception{
 ...
 //BA.debugLineNum = 83;BA.debugLine="StartActivity(raeesi)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._raeesi.getObject()));
...
public static String  _button5_click() throws Exception{
 ...
 //BA.debugLineNum = 88;BA.debugLine="Msgbox(\"اگر نام شما در لیست نیست از قسمت ارتباط ب";
...
public static String  _imageview1_click() throws Exception{
 //BA.debugLineNum = 35;BA.debugLine="Sub ImageView1_Click";
...
public static String  _imageview2_click() throws Exception{
 //BA.debugLineNum = 41;BA.debugLine="Sub ImageView2_Click";
 //BA.debugLineNum = 42;BA.debugLine="StartActivity(doomadi)";
...
public static String  _imageview3_click() throws Exception{
 //BA.debugLineNum = 45;BA.debugLine="Sub ImageView3_Click";
 //BA.debugLineNum = 48;BA.debugLine="StartActivity(ostan)";
...
public static String  _imageview4_click() throws Exception{
 //BA.debugLineNum = 52;BA.debugLine="Sub ImageView4_Click";
 //BA.debugLineNum = 55;BA.debugLine="StartActivity(tamas)";
