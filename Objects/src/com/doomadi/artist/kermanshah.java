...
public class kermanshah extends Activity implements B4AActivity{
	public static kermanshah mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.doomadi.artist", "com.doomadi.artist.kermanshah");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (kermanshah).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.doomadi.artist", "com.doomadi.artist.kermanshah");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.doomadi.artist.kermanshah", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (kermanshah) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (kermanshah) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (kermanshah) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._scrollview1.getPanel().setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (120),mostCurrent.activityBA));
 //BA.debugLineNum = 22;BA.debugLine="ostanha.Button(Button1,\"عزیز ویسی\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button1,"عزیز ویسی");
 //BA.debugLineNum = 23;BA.debugLine="ostanha.Button(Button2,\"کیوان دری\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button2,"کیوان دری");
...
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 80;BA.debugLine="StartActivity(\"ostan\")";
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 64;BA.debugLine="StartActivity(azizvisi)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._azizvisi.getObject()));
...
public static String  _button2_click() throws Exception{
 ...
 //BA.debugLineNum = 70;BA.debugLine="StartActivity(dori)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._dori.getObject()));
...
public static String  _imageview1_click() throws Exception{
 //BA.debugLineNum = 38;BA.debugLine="Sub ImageView1_Click";
...
public static String  _imageview2_click() throws Exception{
 //BA.debugLineNum = 44;BA.debugLine="Sub ImageView2_Click";
 //BA.debugLineNum = 45;BA.debugLine="StartActivity(doomadi)";
...
public static String  _imageview3_click() throws Exception{
 //BA.debugLineNum = 48;BA.debugLine="Sub ImageView3_Click";
 //BA.debugLineNum = 51;BA.debugLine="StartActivity(ostan)";
...
public static String  _imageview4_click() throws Exception{
 //BA.debugLineNum = 55;BA.debugLine="Sub ImageView4_Click";
 //BA.debugLineNum = 58;BA.debugLine="StartActivity(tamas)";
