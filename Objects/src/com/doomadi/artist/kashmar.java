...
public class kashmar extends Activity implements B4AActivity{
	public static kashmar mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.doomadi.artist", "com.doomadi.artist.kashmar");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (kashmar).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.doomadi.artist", "com.doomadi.artist.kashmar");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.doomadi.artist.kashmar", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (kashmar) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (kashmar) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (kashmar) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 18;BA.debugLine="Activity.LoadLayout(\"scrol\")";
mostCurrent._activity.LoadLayout("scrol",mostCurrent.activityBA);
 //BA.debugLineNum = 19;BA.debugLine="ScrollView1.Panel.LoadLayout(\"ahang\")";
mostCurrent._scrollview1.getPanel().LoadLayout("ahang",mostCurrent.activityBA);
 //BA.debugLineNum = 20;BA.debugLine="ScrollView1.Panel.Height = 160%y";
mostCurrent._scrollview1.getPanel().setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (160),mostCurrent.activityBA));
 //BA.debugLineNum = 21;BA.debugLine="ostanha.Button(Button1,\"وحید علوی\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button1,"وحید علوی");
 //BA.debugLineNum = 22;BA.debugLine="ostanha.Button(Button2,\"محمدجان علوی\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button2,"محمدجان علوی");
 //BA.debugLineNum = 23;BA.debugLine="ostanha.Button(Button3,\"حسن عابدینی\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button3,"حسن عابدینی");
 //BA.debugLineNum = 24;BA.debugLine="ostanha.Button(Button4,\"حسین رضایی\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button4,"حسین رضایی");
 //BA.debugLineNum = 25;BA.debugLine="ostanha.Button(Button5,\"رحمت حسن زاده\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button5,"رحمت حسن زاده");
 //BA.debugLineNum = 26;BA.debugLine="ostanha.Button(Button6,\"عباس چوپان\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button6,"عباس چوپان");
 //BA.debugLineNum = 27;BA.debugLine="ostanha.Button(Button7,\"رضا ژیان\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button7,"رضا ژیان");
 //BA.debugLineNum = 28;BA.debugLine="ostanha.Button(Button8,\"سلمان برقی\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button8,"سلمان برقی");
 //BA.debugLineNum = 29;BA.debugLine="ostanha.Button(Button9,\"محسن خاکشور\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button9,"محسن خاکشور");
 //BA.debugLineNum = 30;BA.debugLine="ostanha.Button(Button10,\"مهدی صدوقیان\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button10,"مهدی صدوقیان");
...
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 135;BA.debugLine="StartActivity(\"razavi\")";
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 68;BA.debugLine="StartActivity(alavivahid)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._alavivahid.getObject()));
...
public static String  _button10_click() throws Exception{
 //BA.debugLineNum = 119;BA.debugLine="Sub Button10_Click";
 //BA.debugLineNum = 121;BA.debugLine="StartActivity(sedooghi)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._sedooghi.getObject()));
...
public static String  _button11_click() throws Exception{
 //BA.debugLineNum = 125;BA.debugLine="Sub Button11_Click";
 //BA.debugLineNum = 127;BA.debugLine="Msgbox(\"اگر نام شما در لیست نیست از قسمت ارتباط ب";
...
public static String  _button2_click() throws Exception{
 ...
 //BA.debugLineNum = 73;BA.debugLine="StartActivity(mamadjan)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._mamadjan.getObject()));
...
public static String  _button3_click() throws Exception{
 //BA.debugLineNum = 77;BA.debugLine="Sub Button3_Click";
 //BA.debugLineNum = 78;BA.debugLine="StartActivity(abdini)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._abdini.getObject()));
...
public static String  _button4_click() throws Exception{
 ...
 //BA.debugLineNum = 83;BA.debugLine="StartActivity(rezaee)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._rezaee.getObject()));
...
public static String  _button5_click() throws Exception{
 //BA.debugLineNum = 87;BA.debugLine="Sub Button5_Click";
 //BA.debugLineNum = 88;BA.debugLine="StartActivity(hasanzadeh)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._hasanzadeh.getObject()));
...
public static String  _button6_click() throws Exception{
 //BA.debugLineNum = 92;BA.debugLine="Sub Button6_Click";
 //BA.debugLineNum = 94;BA.debugLine="StartActivity(choopan)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._choopan.getObject()));
...
public static String  _button7_click() throws Exception{
 //BA.debugLineNum = 99;BA.debugLine="Sub Button7_Click";
 //BA.debugLineNum = 101;BA.debugLine="StartActivity(zhiyan)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._zhiyan.getObject()));
...
public static String  _button8_click() throws Exception{
 ...
 //BA.debugLineNum = 108;BA.debugLine="StartActivity(barghi)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._barghi.getObject()));
...
public static String  _button9_click() throws Exception{
 //BA.debugLineNum = 114;BA.debugLine="Sub Button9_Click";
 //BA.debugLineNum = 115;BA.debugLine="StartActivity(khakshoor)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._khakshoor.getObject()));
...
mostCurrent._button10 = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 13;BA.debugLine="Private Button11, Button12, Button13 As Button";
...
public static String  _imageview1_click() throws Exception{
 //BA.debugLineNum = 40;BA.debugLine="Sub ImageView1_Click";
...
public static String  _imageview2_click() throws Exception{
 //BA.debugLineNum = 46;BA.debugLine="Sub ImageView2_Click";
 //BA.debugLineNum = 47;BA.debugLine="StartActivity(doomadi)";
...
public static String  _imageview3_click() throws Exception{
 //BA.debugLineNum = 50;BA.debugLine="Sub ImageView3_Click";
 //BA.debugLineNum = 53;BA.debugLine="StartActivity(ostan)";
...
public static String  _imageview4_click() throws Exception{
 //BA.debugLineNum = 57;BA.debugLine="Sub ImageView4_Click";
 //BA.debugLineNum = 60;BA.debugLine="StartActivity(tamas)";
