...
public class shirvan extends Activity implements B4AActivity{
	public static shirvan mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.doomadi.artist", "com.doomadi.artist.shirvan");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (shirvan).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.doomadi.artist", "com.doomadi.artist.shirvan");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.doomadi.artist.shirvan", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (shirvan) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (shirvan) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (shirvan) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._scrollview1.getPanel().setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (160),mostCurrent.activityBA));
 //BA.debugLineNum = 21;BA.debugLine="ostanha.Button(Button1,\"مرتضی جعفرزاده\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button1,"مرتضی جعفرزاده");
 //BA.debugLineNum = 22;BA.debugLine="ostanha.Button(Button2,\"وحید اقبالی\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button2,"وحید اقبالی");
...
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 79;BA.debugLine="StartActivity(\"shomalikh\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("shomalikh"));
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 60;BA.debugLine="StartActivity(mortzajafarzadeh)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._mortzajafarzadeh.getObject()));
...
public static String  _button2_click() throws Exception{
 ...
 //BA.debugLineNum = 66;BA.debugLine="StartActivity(eghbali)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._eghbali.getObject()));
...
public static String  _button3_click() throws Exception{
 ...
 //BA.debugLineNum = 71;BA.debugLine="Msgbox(\"اگر نام شما در لیست نیست از قسمت ارتباط ب";
...
public static String  _imageview1_click() throws Exception{
 //BA.debugLineNum = 32;BA.debugLine="Sub ImageView1_Click";
 //BA.debugLineNum = 33;BA.debugLine="StartActivity(Main)";
...
public static String  _imageview2_click() throws Exception{
 //BA.debugLineNum = 38;BA.debugLine="Sub ImageView2_Click";
 //BA.debugLineNum = 39;BA.debugLine="StartActivity(doomadi)";
...
public static String  _imageview3_click() throws Exception{
 //BA.debugLineNum = 42;BA.debugLine="Sub ImageView3_Click";
 //BA.debugLineNum = 45;BA.debugLine="StartActivity(ostan)";
...
public static String  _imageview4_click() throws Exception{
 //BA.debugLineNum = 49;BA.debugLine="Sub ImageView4_Click";
 //BA.debugLineNum = 52;BA.debugLine="StartActivity(tamas)";
