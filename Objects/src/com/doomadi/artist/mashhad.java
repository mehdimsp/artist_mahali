...
public class mashhad extends Activity implements B4AActivity{
	public static mashhad mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.doomadi.artist", "com.doomadi.artist.mashhad");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (mashhad).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.doomadi.artist", "com.doomadi.artist.mashhad");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.doomadi.artist.mashhad", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (mashhad) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (mashhad) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (mashhad) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 17;BA.debugLine="Activity.LoadLayout(\"scrol\")";
mostCurrent._activity.LoadLayout("scrol",mostCurrent.activityBA);
 //BA.debugLineNum = 18;BA.debugLine="ScrollView1.Panel.LoadLayout(\"ahang\")";
mostCurrent._scrollview1.getPanel().LoadLayout("ahang",mostCurrent.activityBA);
 //BA.debugLineNum = 19;BA.debugLine="ScrollView1.Panel.Height = 160%y";
mostCurrent._scrollview1.getPanel().setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (160),mostCurrent.activityBA));
 //BA.debugLineNum = 20;BA.debugLine="ostanha.Button(Button1,\"حمید فلاح\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button1,"حمید فلاح");
 //BA.debugLineNum = 21;BA.debugLine="ostanha.Button(Button2,\"صالح جعفرزاده\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button2,"صالح جعفرزاده");
 //BA.debugLineNum = 22;BA.debugLine="ostanha.Button(Button3,\"محمود تقی زاده\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button3,"محمود تقی زاده");
 //BA.debugLineNum = 23;BA.debugLine="ostanha.Button(Button4,\"پویاعبدی\")";
mostCurrent._ostanha._button(mostCurrent.activityBA,mostCurrent._button4,"پویاعبدی");
...
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 95;BA.debugLine="StartActivity(\"razavi\")";
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 62;BA.debugLine="StartActivity(falah)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._falah.getObject()));
...
public static String  _button2_click() throws Exception{
 ...
 //BA.debugLineNum = 68;BA.debugLine="StartActivity(jafarzadeh)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._jafarzadeh.getObject()));
...
public static String  _button3_click() throws Exception{
 ...
 //BA.debugLineNum = 74;BA.debugLine="StartActivity(taghizadeh)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._taghizadeh.getObject()));
...
public static String  _button4_click() throws Exception{
 //BA.debugLineNum = 80;BA.debugLine="Sub Button4_Click";
 //BA.debugLineNum = 81;BA.debugLine="StartActivity(abdi)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._abdi.getObject()));
...
public static String  _button5_click() throws Exception{
 ...
 //BA.debugLineNum = 86;BA.debugLine="Msgbox(\"اگر نام شما در لیست نیست از قسمت ارتباط ب";
...
mostCurrent._scrollview1 = new anywheresoftware.b4a.objects.ScrollViewWrapper();
 //BA.debugLineNum = 12;BA.debugLine="Private Button1, Button2, Button3, Button4, Butto";
...
public static String  _imageview1_click() throws Exception{
 //BA.debugLineNum = 34;BA.debugLine="Sub ImageView1_Click";
...
public static String  _imageview2_click() throws Exception{
 //BA.debugLineNum = 40;BA.debugLine="Sub ImageView2_Click";
 //BA.debugLineNum = 41;BA.debugLine="StartActivity(doomadi)";
...
public static String  _imageview3_click() throws Exception{
 ...
 //BA.debugLineNum = 47;BA.debugLine="StartActivity(ostan)";
...
public static String  _imageview4_click() throws Exception{
 //BA.debugLineNum = 51;BA.debugLine="Sub ImageView4_Click";
 //BA.debugLineNum = 54;BA.debugLine="StartActivity(tamas)";
