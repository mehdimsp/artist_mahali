...
public class barghi extends Activity implements B4AActivity{
	public static barghi mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.doomadi.artist", "com.doomadi.artist.barghi");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (barghi).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.doomadi.artist", "com.doomadi.artist.barghi");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.doomadi.artist.barghi", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (barghi) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (barghi) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (barghi) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._http._initialize(processBA,"http",barghi.getObject());
 //BA.debugLineNum = 102;BA.debugLine="LoadDB(\"SELECT * FROM barghi ORDER BY id DESC LIM";
_loaddb("SELECT * FROM barghi ORDER BY id DESC LIMIT 0,10000000000000");
...
String _str = "";
 //BA.debugLineNum = 560;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
 //BA.debugLineNum = 561;BA.debugLine="If KeyCode=KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 562;BA.debugLine="If Panel1.Visible=True Then";
if (mostCurrent._panel1.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 563;BA.debugLine="If isplaying=True Then";
if (_isplaying==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 564;BA.debugLine="Dim str As String";
_str = "";
 //BA.debugLineNum = 565;BA.debugLine="str=Msgbox2(\"موزیک در حال پخش قطع شود؟؟\",\"doom";
...
if (true) return anywheresoftware.b4a.keywords.Common.True;
 ...
 //BA.debugLineNum = 590;BA.debugLine="ImageView6.Visible=True";
mostCurrent._imageview6.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 592;BA.debugLine="ImageView5.Visible=True";
mostCurrent._imageview5.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 594;BA.debugLine="ImageView4.Visible=True";
mostCurrent._imageview4.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 596;BA.debugLine="ImageView3.Visible=True";
mostCurrent._imageview3.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 601;BA.debugLine="Panel1.SetVisibleAnimated(500,False)";
mostCurrent._panel1.SetVisibleAnimated((int) (500),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 602;BA.debugLine="tin.Initialize(\"tin\",500)";
mostCurrent._tin.Initialize(processBA,"tin",(long) (500));
 //BA.debugLineNum = 603;BA.debugLine="tin.Enabled=True";
mostCurrent._tin.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 };
...
if (true) return anywheresoftware.b4a.keywords.Common.True;
 ...
 //BA.debugLineNum = 611;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 614;BA.debugLine="StartActivity(kashmar)";
...
mostCurrent._http._initialize(processBA,"job3",barghi.getObject());
...
_edit._initialize(processBA,"edit",barghi.getObject());
 //BA.debugLineNum = 374;BA.debugLine="edit.PostString(\"http://doholi.com/edit/edit24.ph";
_edit._poststring("http://doholi.com/edit/edit24.php","VEIW="+BA.NumberToString(_asa)+"&id="+mostCurrent._qqqq);
...
public static String  _tin_tick() throws Exception{
 //BA.debugLineNum = 555;BA.debugLine="Sub tin_Tick";
 //BA.debugLineNum = 556;BA.debugLine="ImageView1.SetBackgroundImage(Null)";
mostCurrent._imageview1.SetBackgroundImageNew((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 558;BA.debugLine="tin.Enabled=False";
