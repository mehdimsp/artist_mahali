...
public class tozih extends Activity implements B4AActivity{
	public static tozih mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.doomadi.artist", "com.doomadi.artist.tozih");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (tozih).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.doomadi.artist", "com.doomadi.artist.tozih");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.doomadi.artist.tozih", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (tozih) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (tozih) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (tozih) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 20;BA.debugLine="Activity.LoadLayout(\"tozih\")";
mostCurrent._activity.LoadLayout("tozih",mostCurrent.activityBA);
 //BA.debugLineNum = 21;BA.debugLine="WebView1.LoadUrl(\"file:///android_asset/\"&\"tozih.";
mostCurrent._webview1.LoadUrl("file:///android_asset/"+"tozih.html");
 //BA.debugLineNum = 22;BA.debugLine="WebView1.ZoomEnabled = False";
mostCurrent._webview1.setZoomEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 23;BA.debugLine="WebView1.Back";
