...
Sub Activity_Create(FirstTime As Boolean)
	...
	LoadDB("SELECT * FROM alinzhad ORDER BY id DESC LIMIT 0,10000000000000")
	Artist.Initialize
	Name.Initialize
	Image.Initialize
...
Sub play_Click
	...
	edit.PostString("http://doholi.com/edit/edit34.php","VEIW="&asa&"&id="&qqqq)
