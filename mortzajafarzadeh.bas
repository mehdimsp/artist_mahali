...
Sub Activity_Create(FirstTime As Boolean)
	...
	LoadDB("SELECT * FROM morjafarzadeh ORDER BY id DESC LIMIT 0,10000000000000")
	Artist.Initialize
	Name.Initialize
	Image.Initialize
...
Sub play_Click
	...
	edit.PostString("http://doholi.com/edit/edit31.php","VEIW="&asa&"&id="&qqqq)
