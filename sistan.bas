...
Sub Activity_Create(FirstTime As Boolean)
	...
	ostanha.Button(Button1,"عبدل علی")
	ostanha.Button(Button2,"عمار")
	ostanha.Button(Button3,"وحید ترکش")
	ostanha.Button(Button4,"ساسان رئیسی")
...
Sub Button3_Click
	...
	StartActivity(tarkesh)
	Activity.Finish
End Sub

Sub Button4_Click

	StartActivity(raeesi)
	Activity.Finish
End Sub
Sub Button5_Click
