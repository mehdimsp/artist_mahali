...
Sub Activity_Create(FirstTime As Boolean)
	...
	File.MakeDir(File.DirRootExternal, "doholi/music")
	...
	LoadDB("SELECT * FROM alavivahid ORDER BY id DESC LIMIT 0,10000000000000")
	Artist.Initialize
	Name.Initialize
	Image.Initialize
...
'			sound.Initialize2("")
'			sound.Load(File.DirRootExternal & "/dohol/imusic", ss)
'			sound.Looping=False
'			sound.Play
...
Sub play_Click
	...
	edit.PostString("http://doholi.com/edit/edit17.php","VEIW="&asa&"&id="&qqqq)

	s=Regex.Split("/",linkplay)
'		Log(s(5))
	ss=s(5)
	If File.Exists(File.DirRootExternal & "/doholi/music",  ss) = False Then
	...
	Else
		...
		Dim sound As MediaPlayer
		sound.Initialize2("")
		sound.Load(File.DirRootExternal & "/doholi/music", ss)
		sound.Looping=False
		sound.Play
...
'		Log(s(5))
	...
	If File.Exists(File.DirRootExternal & "/doholi/music",  ss) = False Then
		Name3= ss
		dier=File.DirRootExternal& "/doholi/music"
