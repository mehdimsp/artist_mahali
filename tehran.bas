...
Sub Activity_Create(FirstTime As Boolean)
	...
	ostanha.Button(Button1,"حسین یوسف")
	ostanha.Button(Button2,"سیاوش یوسفی")
	ostanha.Button(Button3,"یاسر محمودی")
...
Sub Button1_Click
	...
	StartActivity(yousof)
	Activity.Finish
End Sub
Sub Button2_Click
	
	StartActivity(siyavashyosofi)
	Activity.Finish
End Sub

Sub Button3_Click
	
	StartActivity(yasermahmoodi)
	Activity.Finish
End Sub
